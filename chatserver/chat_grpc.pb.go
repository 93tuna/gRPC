...
type ServicesClient interface {
	...
	PingPong(ctx context.Context, in *FromClient, opts ...grpc.CallOption) (*FromServer, error)
}
...
func (c *servicesClient) PingPong(ctx context.Context, in *FromClient, opts ...grpc.CallOption) (*FromServer, error) {
	out := new(FromServer)
	err := c.cc.Invoke(ctx, "/chatserver.Services/PingPong", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServicesServer interface {
	...
	PingPong(context.Context, *FromClient) (*FromServer, error)
...
func (UnimplementedServicesServer) PingPong(context.Context, *FromClient) (*FromServer, error) {
...
func _Services_PingPong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FromClient)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).PingPong(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatserver.Services/PingPong",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).PingPong(ctx, req.(*FromClient))
	}
...
var Services_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PingPong",
			Handler:    _Services_PingPong_Handler,
		},
	},
